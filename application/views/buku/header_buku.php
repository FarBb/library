...
<body>
 ...
 <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar" style="margin-bottom:50px;">
            ...
            <li class="active"><a href="<?php echo base_url() ?>app/buku"><span class="glyphicon glyphicon-book"> </span> Buku</a></li>
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h1 class="sub-header page-header"><span class="glyphicon glyphicon-book"></span>&nbsp;Data Buku</h1>

...
<body>
 ...
 <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <div class="sidebar-footer col-sm-3 col-md-2">
              ...
              href="<?php echo base_url().'app/manageprofile/'.$user; ?>" style="background: #019875;">
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h1 class="sub-header page-header"><span class="glyphicon glyphicon-cog"></span>&nbsp;Manage My Profile</h1>

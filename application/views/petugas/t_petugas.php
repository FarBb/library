...
<?php } ?>
  ...
  <?php } else { ?>
    <a href="<?php echo base_url() ?>app/p_tambah">
  ...
  <div class="col-md-9" style="margin-left: 10px; margin-bottom: 0px">
    <form action="<?php echo base_url() ?>app/p_cari" method="post" 
      ...
      placeholder="Masukkan Nama atau ID Petugas" name="cari" id="cari" style="" autocomplete="off"/>
              ...
              <tbody>
                  <?php foreach ($sql1->result() as $obj1) { ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url().'app/p_ubah/'.sha1(md5($obj1->kode_petugas)); ?>" class="btn btn-success btn-sm btn-cari" data-toggle="tooltip" data-placement="top" title="Ubah">
                          <span class="glyphicon glyphicon-pencil"> </span>
                        </a>
                      </td>
                      <td>
                      <a href="<?php echo base_url().'app/p_hapus/'.sha1(md5($obj1->kode_petugas)); ?>" class="btn btn-danger btn-sm btn-batal" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini ??')" data-toggle="tooltip" data-placement="top" title="Hapus">
